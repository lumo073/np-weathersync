...
import { includesRain, includesSnow, overrideTime, temperatureRanges, windDirections } from '../../shared/config';
import { Weather, WeatherProgression } from "../../shared/types/shared";
import { getRandomInt } from '../../shared/utils/tools';
import { vehicleTemp, vehicleCleaning } from './events';
// PENCECI
