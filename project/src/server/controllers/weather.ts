import { windDirections, includesRain } from '../../shared/config';
import { weightedElement, randomArrElement } from "../../shared/utils/tools"
import { activeWeathers, preproducedTransitions, rainLevels, timePerWeather, transitions, windSpeeds, temperatureRanges } from '../../shared/config';
import { Weather, WeatherProgression } from '../../shared/types/shared';
